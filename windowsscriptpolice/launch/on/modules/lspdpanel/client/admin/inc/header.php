        ...
        <div class="row">
          ...
          <div class=" col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
            ...
            <ul class="navbar-nav flex-column mt-4">
              <li class="nav-item"><a href="index.php" class="nav-link text-white p-2 mb-2 current"><i class="fas fa-home text-light fa-lg mr-3"></i>Dashboard</a></li>
              <li class="nav-item"><a href="contravention.php" class="nav-link text-white p-2 mb-2 current"><i class="fas fa-copy text-light fa-lg mr-3"></i>Tickets</a></li>
              ...
              <li class="nav-item"><a href="news.php" class="nav-link text-white p-2 mb-2 current"><i class="fas fa-user text-light fa-lg mr-3"></i>News</a></li>
              <li class="nav-item"><a href="recrutement.php" class="nav-link text-white p-2 mb-2 current"><i class="fas fa-user text-light fa-lg mr-3"></i>Recrutement</a></li>
            </ul>
            </ul>
          </div>
          <!------End of Sidebar--->
