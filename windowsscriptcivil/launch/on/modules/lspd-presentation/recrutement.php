...
<head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="msapplication-tap-highlight" content="no">
	...
	<div class="b-gal-w cf">
		<div class="b-gal-item cf wnd-orientation-landscape">
			<a class="b-gal-a litebox" data-litebox-group="gallery" data-litebox-text="" href="assets/img/7.png" width="1920" height="1080">
				<div class="b-gal-img">
                    <div class="b-gal-img-transition">
                        <img src="assets/img/7.png" alt="" width="200" height="113">
</div>
                </div>
				<div class="b-gal-t"><span><span></span></span></div>
			</a>
		</div><div class="b-gal-item cf wnd-orientation-landscape">
			<a class="b-gal-a litebox" data-litebox-group="gallery" data-litebox-text="" href="assets/img/6.png" width="1914" height="1052">
				<div class="b-gal-img">
                    <div class="b-gal-img-transition">
                        <img src="assets/img/6.png" alt="" width="200" height="110">
</div>
                </div>
				<div class="b-gal-t"><span><span></span></span></div>
			</a>
	...
	<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><p class="wnd-align-center"><strong><?php echo $data['description_recrutement']; ?></strong></p></div>
</div><div class="b form block cf typo-03">
	<form action="add-recrutement.php" method="post">

		<fieldset class="form-fieldset">
<div><div class="form-input form-text cf wnd-form-field wnd-required">
	<label for="field-wnd_ShortTextField_30696"><span class="inline-text">
	<span><?php echo $data['nom_recrutement']; ?></span>
</span></label>
	<input id="field-wnd_ShortTextField_30696" name="nom" required value="" placeholder="Marcel Dupond" type="text" maxlength="150">
</div><div class="form-input form-email cf wnd-form-field wnd-required">
	<label for="field-wnd_EmailField_741356"><span class="inline-text">
	<span><?php echo $data['id_discord_recrutement']; ?></span>
</span></label>
	<input id="field-wnd_EmailField_741356" name="discord_id" required value="" placeholder="EXEMPLE#0000" type="text" maxlength="255">
</div><div class="form-input form-textarea cf wnd-form-field wnd-required">
	<label for="field-wnd_LongTextField_540331"><span class="inline-text">
	<span><?php echo $data['candidature_recrutement']; ?></span>
</span></label>
	<textarea rows="5" id="field-wnd_LongTextField_540331" name="candidature" required></textarea>
</div></div>
		</fieldset>

		<div class="form-submit b-btn cf b-btn-1">
		<input type="submit" class="b-btn-l" value="Soumettre">
		</div>
