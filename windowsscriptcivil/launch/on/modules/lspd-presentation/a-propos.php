...
<head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><title>Site web 1</title><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="msapplication-tap-highlight" content="no">
	...
	<head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><title>À propos :: Site web 1</title><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="msapplication-tap-highlight" content="no"><link href="../../d1di2lzuh97fh2.cloudfront.net/files/3z/3zc/3zcnn7e841.css?ph=15f1bfc71f" rel="stylesheet"><link href="../../d1di2lzuh97fh2.cloudfront.net/files/45/45t/45tcx8e841.css?ph=15f1bfc71f" rel="stylesheet"><link rel="stylesheet" href="../../d1di2lzuh97fh2.cloudfront.net/files/1s/1sw/1swyuke841.css?ph=15f1bfc71f" data-wnd_color_scheme_file=""><link rel="stylesheet" href="../../d1di2lzuh97fh2.cloudfront.net/files/1y/1yl/1yll2ee841.css?ph=15f1bfc71f" data-wnd_additive_color_file=""><link rel="stylesheet" href="../../d1di2lzuh97fh2.cloudfront.net/files/0n/0ny/0nyzrve841.css?ph=15f1bfc71f" data-wnd_typography_file=""><meta name="description" content="Voici l'endroit pour votre texte. Cliquez ici et commencez à taper. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperiam eaque ipsa quae ab."><meta name="keywords" content=""><meta name="generator" content="Webnode 2"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black"><meta name="format-detection" content="telephone=no">

<meta property="og:url" content="index.html"><meta property="og:title" content="À propos :: Site web 1"><meta property="og:type" content="article"><meta property="og:description" content="Voici l'endroit pour votre texte. Cliquez ici et commencez à taper. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperiam eaque ipsa quae ab."><meta property="og:site_name" content="Site web 1"><meta property="og:image" content="../_files/200000005-dda27dda29/700/unknown.png"><meta property="og:article:published_time" content="2020-09-09T00:00:00+0200"><meta name="robots" content="index,follow"><link rel="canonical" href="index.html"><script>window.checkAndChangeSvgColor=function(c){try{var a=document.getElementById(c);if(a){c=[["border","borderColor"],["outline","outlineColor"],["color","color"]];for(var h,b,d,f=[],e=0,m=c.length;e<m;e++)if(h=window.getComputedStyle(a)[c[e][1]].replace(/\s/g,"").match(/^rgb[a]?\(([0-9]{1,3}),([0-9]{1,3}),([0-9]{1,3})/i)){b="";for(var g=1;3>=g;g++)b+=("0"+parseInt(h[g],10).toString(16)).slice(-2);"0"===b.charAt(0)&&(d=parseInt(b.substr(0,2),16),d=Math.max(16,d),b=d.toString(16)+b.slice(-4));f.push(c[e][0]+"="+b)}if(f.length){var k=a.getAttribute("data-src"),l=k+(0>k.indexOf("?")?"?":"&")+f.join("&");a.src!=l&&(a.src=l,a.outerHTML=a.outerHTML)}}}catch(n){}};</script><script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
			(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
			m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
			})(window,document,'script','../../www.google-analytics.com/analytics.js','ga');ga('create', 'UA-797705-6', 'auto',{"name":"wnd_header"});ga('wnd_header.set/index.html', 'dimension1', 'W2');ga('wnd_header.set/index.html', 'anonymizeIp', true);ga('wnd_header.send', 'pageview');</script></head><body class="l l-03 layout-03 c-s-m wt-page ac-s ac-i   b-btn-sq b-btn-s-l b-btn-dn b-btn-bw-1 img-d-n img-t-u img-h-n line-solid b-e-ds lbox-d c-s-m   wnd-fe">
...
<a class="menu-item" href="recrutement.php"><span class="menu-item-text"><?php echo $data['nav_recrutement']; ?></span></a>
	...
	<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><h3 class="wnd-align-center"><?php echo $data['histoire_titre_a_propos']; ?></h3>

<h1 class="wnd-align-center"><strong><?php echo $data['histoire_sous_titre_a_propos']; ?></strong></h1>
</div>
</div></div>
</div><div class="column-content c pr cf" style="width:50%;">
	<div class="c-c c-s-h cf"><div class="b b-text cf">
	<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><p><?php echo $data['description1_a_propos']; ?></p>
</div>
</div></div>
</div></div>
</div><div class="b-img b-img-default b b-s cf wnd-orientation-landscape wnd-type-image img-s-n" style="margin-left:0;margin-right:0;" id="wnd_ImageBlock_22797">
    <div class="b-img-w">
        <div class="b-img-c cf" style="padding-bottom:42.19%;text-align:center;">
            <img src="assets/img/4.png" alt="" style="top:0%;left:0%;width:100%;height:100%;position:absolute;"><div class="b-img-embed">
                </div>
        </div>
	...
	<div class="cw-c c-s-hc cf"><div class="column-content c pr cf" style="width:61.04%;">
	<div class="c-c c-s-h cf"><div class="b-img b-img-default b b-s cf wnd-orientation-landscape wnd-type-image img-s-n" style="margin-left:0;margin-right:0;" id="wnd_ImageBlock_148538">
    <div class="b-img-w">
        <div class="b-img-c cf" style="padding-bottom:56.25%;text-align:center;">
            <img src="assets/img/5.png" alt="" style="top:0%;left:0%;width:100%;height:100%;position:absolute;"><div class="b-img-embed">
                </div>
        </div>
...
</div><div class="column-content c pr cf" style="width:38.96%;">
	<div class="c-c c-s-h cf"><div class="b b-text cf">
	<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><p><?php echo $data['description2_a_propos']; ?></div>
</div></div>
</div></div>
</div></div>
</div>
