  ...
  <div class="container">
    <div class="panel panel-primary dialog-panel">
      <div class="panel-heading">
        <h5>Car mechanic appointment<a href="inc/logout.php"><strong class="logout">Logout</strong></a></h5>
      </div>
      ...
      ?>
            ...
            <div class="position-box">
                  <div class="box">
                    ...
                    <div class="space"></div>
                    <div class="space"></div>
                    <div class="box-info">Type: <?php echo $data['intervention']; ?></div>
                    <div class="space"></div>
                    <div class="box-info">Réparation</div>
                    <div class="box-info"><?php echo $data['engine']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['front_left_wheel']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['front_right_wheel']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['back_right_wheel']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['back_left_wheel']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['first_door_right']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['second_door_right']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['first_door_left']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['second_door_left']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['hood']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['trunk']; ?></div>
                    <div class="space"></div>
                    <div class="space"></div>
                    <div class="space"></div>
                    <div class="box-info">Description</div>
